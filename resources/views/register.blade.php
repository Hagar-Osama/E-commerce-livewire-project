...
<head>
  ...
  <!-- plugins:css -->
  <link rel="stylesheet" href="{{asset('assets/endors/mdi/css/materialdesignicons.min.css')}}">
            ...
            <div class="auth-form-transparent text-left p-3">
              ...
              <form class="pt-3" method="post" action="{{route('register')}}">
                ...
                <div class="text-center mt-4 font-weight-light">
                  Already have an account? <a href="{{route('loginPage')}}" class="text-primary">Login</a>
                </div>
              </form>
            </div>
          </div>
