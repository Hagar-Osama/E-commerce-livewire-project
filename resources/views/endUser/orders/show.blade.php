        ...
        <div class="row">
            <div class="col-md-12">
                <div class="shadow bg-white p-3">
                    <h4 class="text-primary"><i class="fa fa-shopping-cart text-dark"></i> My Order Detail
                        <a href="{{route('orders.index')}}" class="btn btn-danger btn-small float-end">Back</a>
                    </h4>
                    <hr>
                    <div class="row">
                        <div class="col-md-6">
