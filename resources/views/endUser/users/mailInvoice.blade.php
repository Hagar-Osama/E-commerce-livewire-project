...
<body>
    <div class="text-center">
        ...
        <p>
            Thank You For Purchasing with {{$appSettings->website_name ?? 'Amazon E-Commerce'}}
            <br />
            Your Orders Details Are Provided Below
        </p>
    </div>
    ...
    <table>
        ...
        <tr>
            ...
            <td width="15%" class="fw-bold">${{$orderDetail->quantity * $orderDetail->price }}</td>
            @php
