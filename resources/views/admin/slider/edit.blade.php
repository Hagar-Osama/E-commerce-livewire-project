        ...
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            <form class="forms-sample" method="post" action="{{route('slider.update')}}" enctype="multipart/form-data">
                                @csrf
                                @method('PUT')
                                <input type="hidden" name="sliderId" value="{{$slider->id}}">
                                <div class="form-group">
                                    <label for="exampleInputName1">Slider Title</label>
                                    <input type="text" name="title" value="{{$slider->title}}" class="form-control" id="exampleInputName1" placeholder="Title">
                                </div>
                                @error('title')
                                <div class="alert alert-danger">
                                    {{$message}}
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea name="description" class="form-control" id="exampleTextarea1" rows="4">{{$slider->description}}</textarea>
                                </div>
                                @error('description')
                                <div class="alert alert-danger">
                                    {{$message}}
                                ...
                                <div class="form-group">
                                    ...
                                    <img src="{{asset('storage/sliders/'. $slider->image)}}" width="80px" height="80px" />
                                </div>
                                @error('image')
                                <div class="alert alert-danger">
                                    {{$message}}
                                        ...
                                        <div class="col-sm-4">
                                            <div class="form-check">
                                                <label class="form-check-label">
                                                    ...
                                                    value="visible" {{$slider->status == 'visible' ? 'checked' : ""}}>
                                                    Visible
                                                </label>
                                            </div>
                                        </div>
                                        <div class="col-sm-5">
                                            <div class="form-check">
                                                <label class="form-check-label">
                                                    ...
                                                    value="hidden" {{$slider->status == 'hidden' ? 'checked' : ""}}>
                                                    Hidden
                                                </label>
                                            </div>
                                        </div>
