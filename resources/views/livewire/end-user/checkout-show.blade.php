                ...
                <div class="col-md-12 mb-4">
                    <div class="shadow bg-white p-3">
                        <h4 class="text-primary">
                            Item Total Amount :
                            <span class="float-end">${{$productTotalPrice}}</span>
                        </h4>
                        <hr>
...
@push('scripts')
<script src="https://www.paypal.com/sdk/js?client-id=AVAcushm-aJOOvV-n8xir6bdVX5xKy8PY1dtTUdC-eiRtvIf4_kPaRGk_YzpAm046dDK7YCgeUk3fQEH&currency=USD"></script>
<script>
    paypal.Buttons({
        ...
        createOrder: (data, actions) => {
            return actions.order.create({
                purchase_units: [{
                    amount: {
                        value: '{{$this->productTotalPrice}}' // Can also reference a variable or function
                    }
                }]
            });
        },
        ...
        onApprove: (data, actions) => {
            return actions.order.capture().then(function(orderData) {
                ...
                if(transaction.status == 'COMPLETED') {
                    //now here we emit the event and send the data
                    //once the the transaction successful we will this transactionEmit
