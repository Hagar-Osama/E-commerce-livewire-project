...
Route::get('/facebook', [AuthController::class, 'redirectToFacebookLoginPage'])->name('facebookPage');
Route::get('auth/facebook/call-back', [AuthController::class, 'loginViaFacebook'])->name('facebookLogin');
